...
<div class="col-md-6 marginRow">
        <div class="form-group col-md-12 {{ $errors->has('domicile') ? ' has-error' : '' }}">
            <label for="" class="control-label">Kategori</label>
            <select name="category_id" class="select2 form-control" id="cari" style="width: 100%;" $categories->toArray()">
    ...
    <div class="form-group col-md-12">
            ...
            @if (isset($profiles) && $profiles->photo)
            <p>
                <br />
                <img src="{{URL::asset('images/.$profiles->photo') }}" height="100" width="120">
            </p>
            @endif
